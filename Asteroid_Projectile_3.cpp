...
#include "Asteroid_Projectile_3.h"
...
// Sets default values
AAsteroid_Projectile_3::AAsteroid_Projectile_3()
{
...
UParticleSystemComponent* AAsteroid_Projectile_3::CreateFireSmoke(UParticleSystem* FireSmoke)
{
	{
...
// if we hit something
void AAsteroid_Projectile_3::OnHit(UPrimitiveComponent* HitComp, AActor* OtherActor, UPrimitiveComponent* OtherComp, FVector NormalImpulse, const FHitResult& Hit)
{
...
void AAsteroid_Projectile_3::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void AAsteroid_Projectile_3::Tick(float DeltaTime)
{
