...
void ALaser3::OnHit(UPrimitiveComponent* HitComp, AActor* OtherActor, UPrimitiveComponent* OtherComp, FVector NormalImpulse, const FHitResult& Hit)
{
...
void ALaser3::BeginPlay()
{
	Super::BeginPlay();
}

// Called every frame
void ALaser3::Tick(float DeltaTime)
{
	Super::Tick(DeltaTime);
}

// Called to bind functionality to input
void ALaser3::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
