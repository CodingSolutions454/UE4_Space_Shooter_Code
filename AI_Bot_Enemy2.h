...
#include "AI_Bot_Enemy2.generated.h"

class UPawnSensingComponent;

UCLASS()
class SPACESHOOTER_API AAI_Bot_Enemy2 : public ACharacter, public IGenericTeamAgentInterface
{
	GENERATED_BODY()
...
public:
	...
	AAI_Bot_Enemy2(const FObjectInitializer& ObjectInitializer);
...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Gameplay)
		class USoundBase* TrackingLaser1Sound;
...
private:
	...
	UPROPERTY(EditDefaultsOnly, Category = Projectile)
		TSubclassOf<class ATrackingLaser1> ATrackingLaser1class;
	...
	UPROPERTY(EditAnywhere, Category = "Animation")
		UAnimSequence* TrackingLaser1Fire;
