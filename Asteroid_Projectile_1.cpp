...
// Sets default values
AAsteroid_Projectile_1::AAsteroid_Projectile_1()
{
...
UParticleSystemComponent* AAsteroid_Projectile_1::CreateFireSmoke(UParticleSystem* FireSmoke)
{
	{
...
// if we hit something
void AAsteroid_Projectile_1::OnHit(UPrimitiveComponent* HitComp, AActor* OtherActor, UPrimitiveComponent* OtherComp, FVector NormalImpulse, const FHitResult& Hit)
{
...
void AAsteroid_Projectile_1::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void AAsteroid_Projectile_1::Tick(float DeltaTime)
{
