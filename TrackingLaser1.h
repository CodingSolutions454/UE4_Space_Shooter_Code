...
#include "TrackingLaser1.generated.h"

UCLASS()
class SPACESHOOTER_API ATrackingLaser1 : public AActor
{
	GENERATED_BODY()
...
public:
	...
	ATrackingLaser1(const FObjectInitializer& ObjectInitializer);
...
public:
	...
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Mesh")
		class UStaticMeshComponent* TrackingLaser1_Mesh;
